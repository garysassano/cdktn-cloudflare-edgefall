...
The [W07 rocket kernel](./docs/redesign-evidence/W07-rocket-kernel.md) models acceleration, limited steering and exact impact-time explosions, with shared-runtime replay proof. Launcher input, ammunition, room-state and weapon-lab integration remain in progress.
