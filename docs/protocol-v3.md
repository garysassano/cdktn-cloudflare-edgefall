...
Protocol 3.13 adds individual pickup availability in combat section 4 and confirmed inventory grants in 96-byte gameplay events. [Combat archive 15](combat-checkpoint-v15.md) and simulation/recording format 12 retain private contact-entry latches and claim continuation. The content identity binds authored supply definitions as well as launcher guidance and laser profiles. Inputs and acknowledgment sizes remain unchanged; older diagnostic wire versions reject explicitly.
